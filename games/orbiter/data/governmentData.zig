...
pub const GovGeneralPolicyRates = utl.GenDataGrid( f64, TaxGroupEnum, TaxTypeEnum );

// Applies on top of general policies
pub const GovPerResPolicyRates = utl.GenDataGrid( f64, ResType, TaxTypeEnum );
pub const GovPerPopPolicyRates = utl.GenDataGrid( f64, PopType, TaxTypeEnum );
pub const GovPerInfPolicyRates = utl.GenDataGrid( f64, InfType, TaxTypeEnum );
pub const GovPerIndPolicyRates = utl.GenDataGrid( f64, IndType, TaxTypeEnum );
...
pub const GovMonetaryData = utl.GenDataLine( f64, GovMonetaryEnum );
