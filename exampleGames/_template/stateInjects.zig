...
pub fn OnStart( ng : *def.eng.engine ) void // Called by engine.start()    // NOTE : This is where you should initialize your resources
{
...
pub fn OnOpen( ng : *def.eng.engine ) void // Called by engine.open()      // NOTE : This is where you should initialize your entities
{
  _ = ng; // Prevent unused variable warning
}
