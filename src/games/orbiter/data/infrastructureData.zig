...
pub var infMetricData : utl.GenDataGrid( f64, InfType, InfMetricEnum ) = .{};
...
pub var infResMetricTable : utl.GenDataCube( f64, InfType, InfResMetricEnum, ResType ) = .{};
...
pub const InfStateData = utl.GenDataGrid( f64, InfStateEnum, InfType );
